        ...
        <div className="pt-20 pb-12">
          <div className="container mx-auto px-6 text-center">
            ...
            <button
              ...
              className="group relative bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white px-8 py-4 rounded-2xl text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-emerald-500/25 overflow-hidden"
            >
              ...
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-300 -z-10"></div>
            </button>
          </div>
        </div>
